    ...
    <div className="w-64 h-screen bg-[#112240] p-6 flex flex-col shadow-lg">
      ...
      <div className="space-y-4">
        <button
          ...
          className="w-full cursor-pointer p-3 text-lg text-white bg-[#1E3A8A] hover:bg-[#2563EB] hover:scale-105 rounded-lg transition duration-300 shadow-md flex justify-center"
        >
          Registrations
        </button>
